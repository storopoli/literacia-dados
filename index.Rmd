...
Intervalos de confiança foram criados como uma solução para os problemas de má-interpretação dos $p$-valores e sua aplicação se destina ao tamanho do efeito.
...
.washed-blue.bg-red.b--dark-red.ba.bw2.br3.shadow-5.ph4.mt5[
.small[Exemplo: Um intervalo de confiança 95% (1.5-3.5) sinaliza que se eu coletar amostrar do mesmo tamanho que a minha 95% dessas amostras terão um parâmetro entre 1.5 e 3.5. 
]
]

--

.washed-blue.bg-green.b--dark-green.ba.bw2.br3.shadow-5.ph4.mt5[
.small[Isso não é a probabilidade do meu paramêtro estar entre 1.5 e 3.5 - $P(\text{parâmetro} | D)$. Na verdade é uma frequência esperada caso eu amostrasse infinitamente amostras do mesmo tamanho da mesma população - mais uma vez $P(D | \text{parâmetro})$.
]
]

---
# Estatística Clássica Inferencial

.washed-blue.bg-blue.b--navy.ba.bw2.br3.shadow-5.ph4.mt5[
.small[Toda estatística clássica inferencial é baseada em frequências e na probabilidade do seu dado, condicionado a algum paramêtro ou hipótese
$$P(D|H) \text{ ou } P(D | \text{parâmetro})$$
]
]
...
.washed-blue.bg-green.b--dark-green.ba.bw2.br3.shadow-5.ph4.mt5[
.small[Se você quer o contrário: probabilidade da sua hipótese ou parâmetro condicionada aos dados observados
$$P(H|D) \text{ ou } P(\text{parâmetro} | D)$$
Talvez [Estatística Bayesiana](https://storopoli.io/Estatistica-Bayesiana/) lhe interesse.
]
]
...
.washed-blue.bg-green.b--dark-green.ba.bw2.br3.shadow-5.ph4.mt5[
Há uma [disciplina do mestrado e doutorado de Estatística](https://storopoli.io/Estatistica/) que ensina tudo isso. O conteúdo dela e material estão todos abertos e com licença gratuita para uso e compartilhamento.
]
